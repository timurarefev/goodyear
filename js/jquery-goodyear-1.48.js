	...
	jQuery.fn.goodyear = function (options, methods_params) {
		...
		*/
						...
						if (states.mousewheel) {
							minute_picker.mousewheel(function (event) {
								...
								*/
								...
								if (typeof (minute_slider_stop) != "undefined" && !!minute_slider_stop) {
				...
				*/
				...
				if (typeof (goodyear_input.data("goodyearNoIcon")) != "undefined" && !!goodyear_input.data("goodyearNoIcon")) {
