...
Скачайте архив и загрузите к себе на сайт файлы.
...
Настройки для управления календарем:
    ...
    M, MM, MMM - месяц, первый вариант - числа от 1 до 12, второй - всегда две цифры, от 01 до 12, третий вариант - месяц прописью,
